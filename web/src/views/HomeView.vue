<template>
  <div class="home-container">
    ...
    <div v-if="isLoading" class="loading-container">
      <a-spin size="large" />
      <p class="loading-text">서비스에 연결하는 중...</p>
    </div>
    ...
    <div v-else-if="error" class="error-container">
      <a-result status="error" :title="error.title" :sub-title="error.message">
        <template #extra>
          <a-button type="primary" @click="retryLoad">다시 시도</a-button>
          <a-button :href="faqUrl" target="_blank" rel="noopener noreferrer">자주 묻는 질문</a-button>
        </template>
      </a-result>
    </div>
    ...
    <template v-else>
      ...
      <header class="glass-header">
        ...
        <div class="header-actions">
          <a
            class="github-link"
            href="https://github.com/pyhgoshift/AI-KnowledgeHub"
            target="_blank"
              ...
              <div class="flow-diagram">
                <div class="flow-row">
                  <div class="flow-node">
                    ...
                    <span class="flow-name">에이전트 실행 환경</span>
                  </div>
                  ...
                  <div class="flow-node flow-node--hub">
                    ...
                    <span class="flow-name">RAG 엔진</span>
                  </div>
                  ...
                  <div class="flow-node">
                    ...
                    <span class="flow-name">지식베이스</span>
                  </div>
                </div>

                <p class="flow-caption">에이전트가 검색하고 · 엔진이 벡터와 그래프를 결합하며 · 지식으로 답변을 보강합니다</p>
              </div>
...
const repoUrl = 'https://github.com/pyhgoshift/AI-KnowledgeHub'
...
const GITHUB_REPO_API = 'https://api.github.com/repos/pyhgoshift/AI-KnowledgeHub'
...
const getHeroBadgeText = (starsCount = null) => {
  ...
  return realtimeStars ? `GitHub Star ${realtimeStars}개` : ''
}
...
const checkHealth = async () => {
  try {
    ...
    error.value = {
      title: '서비스 연결에 실패했습니다',
      message: '백엔드가 응답하지 않습니다. Docker 서비스가 실행 중인지 확인하세요'
    }
    throw e
  }
}
...
const realtimeStats = computed(() => {
  ...
  return [
    { key: 'stars', label: '스타', value: formatCount(stats.stars), icon: Star },
    { key: 'forks', label: '포크', value: formatCount(stats.forks), icon: GitFork },
    { key: 'issues', label: '열린 이슈', value: formatCount(stats.issues), icon: CircleDot }
  ]
})
</script>
